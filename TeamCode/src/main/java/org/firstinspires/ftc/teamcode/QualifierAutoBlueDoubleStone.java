...
@Disabled
@Autonomous(name= "QualifierAutoBlueDoubleStone", group= "None")
public class QualifierAutoBlueDoubleStone extends OpMode {
    ...
    private static final int PLACE_SECOND_STONE_STATE = 14;
    private static final int PLACE_SECOND_STONE_STATE2 = 15;
    private static final int PARK_STATE = 16;

    private static final int FIRST_STONE_FAIL_STATE = 30;
    ...
    public void loop() {
        ...
        IntakeOn();
        goToPositionByTime(SkyStonePosition - 14, 47, .4, .5, 0, 1.5, FIRST_MOVE_TO_SKYSTONE_STATE, FIRST_SKYSTONE_PLACE);   //Slowing Down to Grab Stone
        goToPositionByTime(SkyStonePosition - 10, 30, DEFAULT_MOVEMENT_SPEED, DEFAULT_TURN_SPEED, 80, .5, FIRST_SKYSTONE_PLACE, ALIGN_FOUNDATION_STATE);
        ...
        FoundationDown();
        grabRotateStoneAtBeginningOfState(SECOND_FOUNDATION_STATE);
        goToPositionByTime(16, 50, DEFAULT_MOVEMENT_SPEED, DEFAULT_TURN_SPEED, 180, 1, SECOND_FOUNDATION_STATE, BUILD_SITE_STATE);
        goToPositionByTime(30, 0, DEFAULT_MOVEMENT_SPEED, DEFAULT_TURN_SPEED, 90, 2.5, BUILD_SITE_STATE, BUILD_SITE_STATE2);
        releaseStoneAtBeginningOfState(BUILD_SITE_STATE2);
        goToPositionByTime(20, 15, DEFAULT_MOVEMENT_SPEED, DEFAULT_TURN_SPEED, 90, .1, BUILD_SITE_STATE2, SECOND_SKYSTONE_STATE);
        FoundationUp();
        goToPositionByTime(20, 44, DEFAULT_MOVEMENT_SPEED, DEFAULT_TURN_SPEED, 90, 2.5, SECOND_SKYSTONE_STATE, SECOND_SKYSTONE_TAKE);
        releaseStoneAtBeginningOfState(SECOND_SKYSTONE_TAKE);
        goToPositionByTime(40, 40, DEFAULT_MOVEMENT_SPEED, DEFAULT_TURN_SPEED, 90, .15, SECOND_SKYSTONE_TAKE, SECOND_SKYSTONE_TAKE2);
        CheckStone(SECOND_SKYSTONE_TAKE2, PARK_STATE);
        lowerLiftDuringState(SECOND_SKYSTONE_TAKE2);
        goToPositionByTime(SkyStonePosition + 8, 30, DEFAULT_MOVEMENT_SPEED, DEFAULT_TURN_SPEED, 90, 1, SECOND_SKYSTONE_TAKE2, SECOND_SKYSTONE_TAKE3);
        goToPositionByTime(SkyStonePosition + 8, 76, DEFAULT_MOVEMENT_SPEED, DEFAULT_TURN_SPEED, 90, 1, SECOND_SKYSTONE_TAKE3, SECOND_SKYSTONE_PLACE);
        goToPositionByTime(SkyStonePosition + 14, 76, DEFAULT_MOVEMENT_SPEED, DEFAULT_TURN_SPEED, 90, 1.5, SECOND_SKYSTONE_PLACE, SECOND_SKYSTONE_PLACE2);
        goToPositionByTime(SkyStonePosition + 14, 35, DEFAULT_MOVEMENT_SPEED, DEFAULT_TURN_SPEED, 90, .7, SECOND_SKYSTONE_PLACE2, SECOND_SKYSTONE_PLACE3);
        goToPositionByTime(68, 35, DEFAULT_MOVEMENT_SPEED, DEFAULT_TURN_SPEED, 90, .8, SECOND_SKYSTONE_PLACE3, PLACE_SECOND_STONE_STATE);
        grabRotateStoneAtBeginningOfState(PLACE_SECOND_STONE_STATE);
        goToPositionByTime(20, 35, .6, .6, 90, 3, PLACE_SECOND_STONE_STATE, PLACE_SECOND_STONE_STATE2);
        releaseStoneAtBeginningOfState(PLACE_SECOND_STONE_STATE2);
        goToPositionByTime(20, 38, DEFAULT_MOVEMENT_SPEED, DEFAULT_TURN_SPEED, 90, .2, PLACE_SECOND_STONE_STATE2, PARK_STATE);
        goToPositionByTime(64,37, .5, .7, 90, 1.5, PARK_STATE, PARK_STATE);
...
//            stoneGrab = true;
        ...
        else if (grabRotateStoneCommand == false) {
            stoneGrab = true;
        }
    }
