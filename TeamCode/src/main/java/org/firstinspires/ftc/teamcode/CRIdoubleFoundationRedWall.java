...
@Autonomous(name= "CRIdoubleFoundationRedWall", group= "None")
public class CRIdoubleFoundationRedWall extends OpMode {
    ...
    private static final int FIRST_MOVE_TO_NEUTRAL_FOUNDATION = 0;
    private static final int PULL_NEUTRAL_FOUNDATION = 10;
    private static final int GRAB_RED_FOUNDATION = 20;
    private static final int GRAB_RED_FOUNDATION2 = 30;
    private static final int GRAB_RED_FOUNDATION3 = 40;
    private static final int GRAB_RED_FOUNDATION4 = 50;
    ...
    public void loop() {
        ...
        IntakeReleaseServo.setPosition(.2);
        //LiftFinishDown();

        FoundationDown();
        goToPositionByTime(0, -63, 1, .5, 0, 3, INIT_STATE, FIRST_MOVE_TO_NEUTRAL_FOUNDATION);
        goToPositionByTime(0, -30, DEFAULT_MOVEMENT_SPEED, DEFAULT_TURN_SPEED, 0, 3, FIRST_MOVE_TO_NEUTRAL_FOUNDATION, PULL_NEUTRAL_FOUNDATION);
        FoundationUp();
        goToPositionByTime(-42, -30, DEFAULT_MOVEMENT_SPEED, DEFAULT_TURN_SPEED, 0, 3, PULL_NEUTRAL_FOUNDATION, GRAB_RED_FOUNDATION);
        FoundationDown();
        goToPositionByTime(-42, -36, DEFAULT_MOVEMENT_SPEED, DEFAULT_TURN_SPEED, 0, 1.5, GRAB_RED_FOUNDATION, GRAB_RED_FOUNDATION2);
        goToPositionByTime(-30, -10, DEFAULT_MOVEMENT_SPEED, DEFAULT_TURN_SPEED, 90, 2, GRAB_RED_FOUNDATION2, GRAB_RED_FOUNDATION3);
        goToPositionByTime(-26, -30, DEFAULT_MOVEMENT_SPEED, DEFAULT_TURN_SPEED, 90, 2, GRAB_RED_FOUNDATION3, GRAB_RED_FOUNDATION4);
        FoundationUp();
        goToPositionByTime(42, 0, DEFAULT_MOVEMENT_SPEED, DEFAULT_TURN_SPEED, 90, 3, GRAB_RED_FOUNDATION4, PARK_STATE);
...
//            }
    ...
    private void FoundationDown() {
        if (autoState == INIT_STATE || autoState == GRAB_RED_FOUNDATION) {
...
//    }
    ...
    private void FoundationUp() {
        if (autoState == PULL_NEUTRAL_FOUNDATION || autoState == GRAB_RED_FOUNDATION4) {
            lFoundationator.setPosition(0);
            rFoundationator.setPosition(foundationatorPosition);
        }
    }
