...
@Autonomous (name= "FoundationAutoBlueWall", group= "None")
public class FoundationAutoBlueWall extends SkystoneVuforiaNew {
...
//                rFoundationator.setPosition(foundationatorPosition);
    ...
    public void driveToPark (OdometryGlobalCoordinatePosition position) {
        goToPositionMrK(-6,-9,.7, .5,-90); //TODO change -90 to 270 if problems
    }
