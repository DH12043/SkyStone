...
public class MathFunctions {
    ...
    public static ArrayList<Point> lineCircleIntersection(Point circleCenter, double r, Point start, Point end){

        double circleX = circleCenter.x;
        double circleY = circleCenter.y;

        double lineX1 = start.x, lineY1 = start.y;
        double lineX2 = end.x, lineY2 = end.y;
