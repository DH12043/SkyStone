...
public class QualifierAutoRedFull extends OpMode {
    ...
    public void loop() {
        ...
        goToPositionByTime(SkyStonePosition - 11, 52, .4, .5, 0, 1.7, FIRST_MOVE_TO_SKYSTONE_STATE2, FIRST_SKYSTONE_PLACE);   //Slowing Down to Grab Stone
        ...
        goToPositionByTime(SkyStonePosition - 26, 36, DEFAULT_MOVEMENT_SPEED, DEFAULT_TURN_SPEED, 270, 1, SECOND_SKYSTONE_TAKE4, SECOND_SKYSTONE_TAKE6);
        goToPositionByTime(SkyStonePosition - 26, 15, DEFAULT_MOVEMENT_SPEED, DEFAULT_TURN_SPEED, 0, 1.5, SECOND_SKYSTONE_TAKE6, SECOND_SKYSTONE_PLACE);
        retractArmDuringState(SECOND_SKYSTONE_PLACE, SECOND_SKYSTONE_PLACE2);
        goToPositionByTime(SkyStonePosition - 26, 38, .4, .4, 0, 2, SECOND_SKYSTONE_PLACE2, SECOND_SKYSTONE_PLACE3);
        goToPositionByTime(SkyStonePosition - 26, 30, DEFAULT_MOVEMENT_SPEED, DEFAULT_TURN_SPEED, 270, 1, SECOND_SKYSTONE_PLACE3, PARK_STATE);
        lowerLiftState(PARK_STATE, PARK_STATE2);
        goToPositionByTime(90,37, DEFAULT_MOVEMENT_SPEED, DEFAULT_TURN_SPEED, 270, 1, PARK_STATE2, PARK_STATE3);
        grabRotateStoneAtBeginningOfState(PARK_STATE3, PARK_STATE4);
        goToPositionByTime(115,38, DEFAULT_MOVEMENT_SPEED, DEFAULT_TURN_SPEED, 270, 4.1, PARK_STATE4, PARK_STATE5);
        releaseStoneAtBeginningOfState(PARK_STATE5, PARK_STATE6);
        goToPositionByTime(117,38, DEFAULT_MOVEMENT_SPEED, DEFAULT_TURN_SPEED, 270, .75, PARK_STATE6, PARK_STATE6_7);
        retractArmDuringState(PARK_STATE6_7, PARK_STATE7);
        goToPositionByTime(100,33, DEFAULT_MOVEMENT_SPEED, DEFAULT_TURN_SPEED, 270, 3.2, PARK_STATE7, PARK_STATE8);
        lowerLiftState(PARK_STATE8, PARK_STATE9);
        goToPositionByTime(82,33, DEFAULT_MOVEMENT_SPEED, DEFAULT_TURN_SPEED, 270, 2, PARK_STATE9, PARK_STATE10);

        retractArmDuringState(FIRST_STONE_FAIL_STATE, FIRST_STONE_FAIL_STATE2);
        goToPositionByTime(110,30, DEFAULT_MOVEMENT_SPEED, DEFAULT_TURN_SPEED, 270, 3.4, FIRST_STONE_FAIL_STATE2, FIRST_STONE_FAIL_STATE3);
        ...
        goToPositionByTime(120, 33, DEFAULT_MOVEMENT_SPEED, DEFAULT_TURN_SPEED, 270, .5, FIRST_STONE_FAIL_STATE6, FIRST_STONE_FAIL_STATE7);
        retractArmDuringState(FIRST_STONE_FAIL_STATE7, FIRST_STONE_FAIL_STATE8);
        goToPositionByTime(95, 34, DEFAULT_MOVEMENT_SPEED, DEFAULT_TURN_SPEED, 270, 2.9, FIRST_STONE_FAIL_STATE8, FIRST_STONE_FAIL_STATE9);
        CheckStone(FIRST_STONE_FAIL_STATE9, EMERGENCY_PARK_STATE);
        lowerLiftState(FIRST_STONE_FAIL_STATE9, FIRST_STONE_FAIL_STATE10);
        goToPositionByTime(SkyStonePosition - 14, 30, DEFAULT_MOVEMENT_SPEED, DEFAULT_TURN_SPEED, 270, 1.2, FIRST_STONE_FAIL_STATE10, FIRST_STONE_FAIL_STATE11);
        goToPositionByTime(SkyStonePosition - 14, 22, DEFAULT_MOVEMENT_SPEED, DEFAULT_TURN_SPEED, 0, 1.3, FIRST_STONE_FAIL_STATE11, FIRST_STONE_FAIL_STATE12);
        goToPositionByTime(SkyStonePosition - 17, 40, DEFAULT_MOVEMENT_SPEED, DEFAULT_TURN_SPEED, 0, 1.3, FIRST_STONE_FAIL_STATE12, FIRST_STONE_FAIL_STATE13);
        goToPositionByTime(SkyStonePosition - 17, 30, DEFAULT_MOVEMENT_SPEED, DEFAULT_TURN_SPEED, 270, .75, FIRST_STONE_FAIL_STATE13, FIRST_STONE_FAIL_STATE14);
