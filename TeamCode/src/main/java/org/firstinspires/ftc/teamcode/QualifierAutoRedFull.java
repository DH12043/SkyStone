...
public class QualifierAutoRedFull extends OpMode {
    ...
    public void loop() {
        ...
        goToPositionByTime(128, 51, DEFAULT_MOVEMENT_SPEED, DEFAULT_TURN_SPEED, 180, 1, BUILD_SITE_STATE, BUILD_SITE_STATE2);
...
//        hoverLiftState(SECOND_SKYSTONE_TAKE5, SECOND_SKYSTONE_TAKE6, 5);
        goToPositionByTime(SkyStonePosition - 4, 60, DEFAULT_MOVEMENT_SPEED, DEFAULT_TURN_SPEED, 270, 1, SECOND_SKYSTONE_TAKE6, SECOND_SKYSTONE_PLACE);
        retractArmDuringState(SECOND_SKYSTONE_PLACE, SECOND_SKYSTONE_PLACE2);
        goToPositionByTime(SkyStonePosition - 10, 60, DEFAULT_MOVEMENT_SPEED, DEFAULT_TURN_SPEED, 270, 1.5, SECOND_SKYSTONE_PLACE2, SECOND_SKYSTONE_PLACE3);
        goToPositionByTime(SkyStonePosition - 10, 30, DEFAULT_MOVEMENT_SPEED, DEFAULT_TURN_SPEED, 270, .7, SECOND_SKYSTONE_PLACE3, PARK_STATE);
