...
@Autonomous(name= "QualifierAutoBlue", group= "None")
public class AutoSingleStoneFoundationBlue extends SkystoneVuforiaNew {
    ...
    public void loop() {
        ...
        goToPositionByTime(118, 30, DEFAULT_MOVEMENT_SPEED, DEFAULT_TURN_SPEED, 90, 1.3, ALIGN_FOUNDATION_STATE, FOUNDATION_STATE);
        lowerLiftDuringState(ALIGN_FOUNDATION_STATE);
        goToPositionByTime(118, 20, DEFAULT_MOVEMENT_SPEED, DEFAULT_TURN_SPEED, 180, .5, FOUNDATION_STATE, SECOND_FOUNDATION_STATE);
        FoundationDown();
        ...
        goToPositionByTime(114, 15, DEFAULT_MOVEMENT_SPEED, DEFAULT_TURN_SPEED, 90, 3.5, BUILD_SITE_STATE, BUILD_SITE_STATE2);
        releaseStoneAtBeginningOfState(BUILD_SITE_STATE2);
        goToPositionByTime(124, 0, DEFAULT_MOVEMENT_SPEED, DEFAULT_TURN_SPEED, 90, 2.5, BUILD_SITE_STATE2, SECOND_SKYSTONE_STATE);
        FoundationUp();
        goToPositionByTime(124, 40, DEFAULT_MOVEMENT_SPEED, DEFAULT_TURN_SPEED, 90, 1, SECOND_SKYSTONE_STATE, SECOND_SKYSTONE_TAKE);           //TODO CHANGE TO SECOND_SKYSTONE_TAKE Instead of PARK_STATE
