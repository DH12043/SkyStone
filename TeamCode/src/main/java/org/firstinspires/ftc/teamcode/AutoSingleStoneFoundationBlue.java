...
public class AutoSingleStoneFoundationBlue extends SkystoneVuforiaNew {
    ...
    public void loop() {
        ...
        FoundationUp();
        goToPositionByTime(124, 40, DEFAULT_MOVEMENT_SPEED, DEFAULT_TURN_SPEED, 90, 1, SECOND_SKYSTONE_STATE, PARK_STATE);           //TODO CHANGE TO SECOND_SKYSTONE_TAKE Instead of PARK_STATE
